<%@ Page Language="vb" AutoEventWireup="true" MasterPageFile="~/Site.Master"  CodeBehind="Wish-List3.aspx.vb" Inherits="WebApplication1.Wish_List" EnableEventValidation="false" ViewStateMode="Disabled" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">    
        ...
        <ContentTemplate>
            ...
            <div id="updatePart" class="container-fluid hideProp" runat="server">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div id="pnDisplayImage" class="shadow-to-box">    
                            <div class="row" style="padding: 20px 0;">
            ...
            <div id="updatePart2" class="container-fluid hideProp" runat="server">
                <div class="row">
                        ...
                        <div id="pnUpdatePart2" class="shadow-to-box">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6" style="float: right; text-align: right !important;">
                                    <asp:Button ID="btnUpdate3" Text="update" class="btn btn-primary btn-lg btnMidSize" runat="server" />
                                </div>
                    ...
                    <div class="col-md-6">
                        <div id="pnDisplayImage2" class="shadow-to-box">    
                            <div class="row" style="padding: 20px 0;">
                        ...
                        <div id="pnProdDev1" class="shadow-to-box">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6" style="padding-top: 20px;">
                                    <div class="row">
                                        <div class="col-md-6" style="float: right; text-align: right !important;">
                                            <asp:Button ID="btnCreateProjectPD" Text="create project" class="btn btn-primary btn-lg btnFullSize" OnClick="btnCreateProjectPD_Click" runat="server" />
                                        </div>
                                        <div class="col-md-6" style="float: left;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="rowBtnFilters" class="row make-it-flex">
                                                ...
                                                <div class="col-xs-12 col-sm-6 flex-item-2 padd-fixed">
                                                    <asp:Button ID="btnUpdate" class="btn btn-primary btn-lg btnFullSize" runat="server" Text="UPDATE" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript"> 
        ...
        $('body').on('click', '#MainContent_btnBack3', function (e) {
            ...
            var hdFile = document.getElementById('<%=hiddenName.ClientID%>').value
            if (hdFile == "1") {
                $('#<%=hiddenId2.ClientID %>').val("0")                
            }
        });
        ...
        $('body').on('click', '#MainContent_btnPDBack', function (e) {
            ...
            var hdFile = document.getElementById('<%=hiddenId4.ClientID%>').value
            if (hdFile == "1") {
                $('#<%=hiddenId5.ClientID %>').val("0")
            }
        });
        ...
        $('body').on('click', '#MainContent_btnImportExcel', function (e) {
            ...
            if (hdFile == "0") 
                ...
                $('#<%=hdUpdateFullRefFlag.ClientID %>').val("0")  
                $('#<%=hdUpdateMedRefFlag.ClientID %>').val("0")  
                $('#<%=hdProdDevFlag.ClientID 

#End ExternalSource

#ExternalSource("C:\Users\aavila\source\repos\WEB_CTPSYSTEM1.2\WebApplication1\Modules\Wish-List.aspx",73)
__o = hdProdDevFlag.ClientID

#End ExternalSource

#ExternalSource("C:\Users\aavila\source\repos\WEB_CTPSYSTEM1.2\WebApplication1\Modules\Wish-List.aspx",74)
__o = hdFileImportFlag.ClientID 

#End ExternalSource

#ExternalSource("C:\Users\aavila\source\repos\WEB_CTPSYSTEM1.2\WebApplication1\Modules\Wish-List.aspx",75)
__o = hdNewRef1Flag.ClientID 

#End ExternalSource

#ExternalSource("C:\Users\aavila\source\repos\WEB_CTPSYSTEM1.2\WebApplication1\Modules\Wish-List.aspx",76)
__o = hdNewRef2Flag.ClientID 

#End ExternalSource

#ExternalSource("C:\Users\aavila\source\repos\WEB_CTPSYSTEM1.2\WebApplication1\Modules\Wish-List.aspx",77)
__o = hdNewRef3Flag.ClientID 

#End ExternalSource

#ExternalSource("C:\Users\aavila\source\repos\WEB_CTPSYSTEM1.2\WebApplication1\Modules\Wish-List.aspx",78)
__o = hdUpdateFullRefFlag.ClientID 

#End ExternalSource

#ExternalSource("C:\Users\aavila\source\repos\WEB_CTPSYSTEM1.2\WebApplication1\Modules\Wish-List.aspx",79)
__o = hdUpdateMedRefFlag.ClientID 

#End ExternalSource

#ExternalSource("C:\Users\aavila\source\repos\WEB_CTPSYSTEM1.2\WebApplication1\Modules\Wish-List.aspx",80)
__o = hdProdDevFlag.ClientID %>').val("0")
        });
        ...
        $('body').on('click', "#MainContent_btnBack", function (e) {
            ...
            var hdFile = document.getElementById('<%=hdUportFlag.ClientID%>').value
            if (hdFile == "1")                
                $('#<%=hdFileImportFlag.ClientID %>').val("0")             
        }); 
        ...
        $('body').on('click', "#MainContent_btnBackItemm2", function (e) {
            ...
            var hdNew1 = document.getElementById('<%=hdUpdateFullRefFlag.ClientID%>').value
            if (hdNew1 == "1")                
                $('#<%=hdUpdateFullRefFlag.ClientID %>').val("0")
        ...
        $('body').on('click', '#MainContent_btnSubmitItem', function (e) {
            ...
            if ($("#MainContent_txtPartNumber").val().length > 0) {
                //var hdNew2 = document.getElementById('<%=hdFileID%>').value
