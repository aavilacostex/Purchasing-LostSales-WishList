...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:DropDownList ID="ddlVendAssign" name="sel-vndassigned" AutoPostBack="true" class="form-control" title="Both: It shows Parts with vendors assigned and without vendors assigned at the same time." ViewStateMode="enabled" runat="server"></asp:DropDownList>                                                                                           </div>
                                                </div>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div id="rowGridView">
                                <asp:GridView ID="grvLostSales" runat="server" AutoGenerateColumns="false"
                                    ...
                                    DataKeyNames="IMPTN" ViewStateMode="Enabled" EnableViewState="true" >
                                    <Columns>
    ...
    <script type="text/javascript">
        ...
        $('body').on('change', "#<%=ddlVendorName.ClientID %>", function () {
            var value = document.getElementById("<%=ddlVendorName.ClientID %>");
            var gettext = value.options[value.selectedIndex].text;
            var getindex = value.options[value.selectedIndex].value;
            $('#<%=hdVendorName.ClientID %>').val(getindex);

            var value1 = document.getElementById("<%=ddlVendorName.ClientID %>").id;
            $('#<%=selectedFilter.ClientID %>').val(value1); 
        });
